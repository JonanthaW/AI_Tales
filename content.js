...
`Generate a ${narrative[Math.floor(Math.random()*narrative.length)]} ${style[Math.floor(Math.random()*style.length)]} about a ${adjective[Math.floor(Math.random()*adjective.length)]} ${noun[Math.floor(Math.random()*noun.length)]} who discovers she has the ability to time-travel`,
`Generate a ${narrative[Math.floor(Math.random()*narrative.length)]} ${style[Math.floor(Math.random()*style.length)]} about a ${adjective[Math.floor(Math.random()*adjective.length)]} ${noun[Math.floor(Math.random()*noun.length)]} who wakes up with the ability to read minds`,
`Generate a ${narrative[Math.floor(Math.random()*narrative.length)]} ${style[Math.floor(Math.random()*style.length)]} about a ${adjective[Math.floor(Math.random()*adjective.length)]} ${noun[Math.floor(Math.random()*noun.length)]} who band together to solve a mystery`,
`Generate a ${narrative[Math.floor(Math.random()*narrative.length)]} ${style[Math.floor(Math.random()*style.length)]} about a ${adjective[Math.floor(Math.random()*adjective.length)]} ${noun[Math.floor(Math.random()*noun.length)]} who befriends a friendly ghost`,
`Generate a ${narrative[Math.floor(Math.random()*narrative.length)]} ${style[Math.floor(Math.random()*style.length)]} about a ${adjective[Math.floor(Math.random()*adjective.length)]} ${noun[Math.floor(Math.random()*noun.length)]} who embark on a quest to find a legendary treasure`,
`Generate a ${narrative[Math.floor(Math.random()*narrative.length)]} ${style[Math.floor(Math.random()*style.length)]} about a ${adjective[Math.floor(Math.random()*adjective.length)]} ${noun[Math.floor(Math.random()*noun.length)]} who develop a society and language of their own`,
